...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.played'
        db.add_column('djpandora_song', 'played', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.is_playing'
        db.add_column('djpandora_song', 'is_playing', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Song.played'
        db.delete_column('djpandora_song', 'played')

        # Deleting field 'Song.is_playing'
        db.delete_column('djpandora_song', 'is_playing')
