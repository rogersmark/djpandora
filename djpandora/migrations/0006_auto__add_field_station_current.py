...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Station.current'
        db.add_column('djpandora_station', 'current', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Station.current'
        db.delete_column('djpandora_station', 'current')
