...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('djpandora_vote', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 4, 17, 10, 40, 24, 434368), blank=True), keep_default=False)

        # Adding field 'Vote.modified'
        db.add_column('djpandora_vote', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 4, 17, 10, 40, 31, 161920), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vote.created'
        db.delete_column('djpandora_vote', 'created')

        # Deleting field 'Vote.modified'
        db.delete_column('djpandora_vote', 'modified')
    ...
    models = {
        ...
        'djpandora.station': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'stop'", 'max_length': '64'})
        },
