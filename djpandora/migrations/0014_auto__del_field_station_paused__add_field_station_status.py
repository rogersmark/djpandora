...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Station.paused'
        db.delete_column('djpandora_station', 'paused')

        # Adding field 'Station.status'
        db.add_column('djpandora_station', 'status', self.gf('django.db.models.fields.CharField')(default='stop', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Station.paused'
        db.add_column('djpandora_station', 'paused', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Station.status'
        db.delete_column('djpandora_station', 'status')
