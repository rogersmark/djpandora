...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('djpandora_song', 'album_art', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Song.album_art'
        db.delete_column('djpandora_song', 'album_art')
