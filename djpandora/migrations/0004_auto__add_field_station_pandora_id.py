...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Station.pandora_id'
        db.add_column('djpandora_station', 'pandora_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=256), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Station.pandora_id'
        db.delete_column('djpandora_station', 'pandora_id')
